...
return {
  ...
  armorClass = 6,
  numAttacks = "1 and 1",
  damage = { { min = 3, max = 12 }, { min = 2, max = 20 } },
  xp = 375,
  xpPerHp = 10,
  xpValue = 805, -- 375 + 10/hp x 43 avg hp
  xpSource = "formula",
  frequency = "uncommon",
  noAppearing = { min = 1, max = 1 },
  lairPct = 0,
  treasure = { individual = nil, inLair = "JN (x10), Q (x5), X" },
