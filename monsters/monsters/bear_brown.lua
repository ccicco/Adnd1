...
return {
  ...
  armorClass = 6,
  numAttacks = 3,
  damage = { { min = 1, max = 6 }, { min = 1, max = 6 }, { min = 1, max = 8 } },
  xp = 225,
  xpPerHp = 8,
