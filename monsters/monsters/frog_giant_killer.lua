...
return {
  ...
  armorClass = 8,
  numAttacks = 3,
  damage = { { min = 1, max = 2 }, { min = 1, max = 2 }, { min = 2, max = 5 } },
  xp = 20,
  xpPerHp = 2,
  xpValue = 36, -- 20 + 2/hp x 8 avg hp
  xpSource = "formula",
  frequency = "very_rare",
