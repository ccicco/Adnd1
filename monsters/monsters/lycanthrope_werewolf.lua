...
return {
  ...
  xp = 90,
  xpPerHp = 5,
  xpValue = 195, -- 90 + 5/hp x 21 avg hp
  xpSource = "formula",
  frequency = "common",
  noAppearing = { min = 3, max = 18 },
  lairPct = 25,
  treasure = { individual = nil, inLair = "6" },
