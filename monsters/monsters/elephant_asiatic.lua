...
return {
  ...
  armorClass = 6,
  numAttacks = 5,
  damage = { { min = 2, max = 12 }, { min = 2, max = 12 }, { min = 2, max = 12 }, { min = 2, max = 12 }, { min = 2, max = 12 } },
  xp = 1500,
  xpPerHp = 14,
  xpValue = 2130, -- 1500 + 14/hp x 45 avg hp
  xpSource = "appendixE",
  frequency = "common",
