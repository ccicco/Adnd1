...
return {
  name = "RHINOCEROS (Woolly Rhinoceros)",
  page = 83,
  hitDice = "10",
  hitDiceNum = 10,
  hitDiceBonus = 0,
  ...
  xp = 900,
  xpPerHp = 12,
  xpValue = 1440, -- 900 + 12/hp x 45 avg hp
  xpSource = "appendixE",
  frequency = "common",
