...
// Rebuild tranche R1: core skeleton
//
//   - Plain Win32 window + message pump, no frameworks
//   - GDI rendering, double-buffered (memory DC), no DirectX/GDI+
//   - 32 px tiles, viewport 25x19 tiles, maps 64x64
//   - Input: arrows/WASD party movement, camera follows party
//   - HUD stub along the bottom
//   - 1e rule hooks stubbed in comments (see "1e HOOK" markers)
//
// Build (MinGW):   g++ adnd1.cpp -o adnd1.exe -mwindows -lgdi32 -luser32
// Build (MSVC):    cl adnd1.cpp user32.lib gdi32.lib
// ============================================================================
...
static const int   HUD_H            = 96;                      // HUD strip height
